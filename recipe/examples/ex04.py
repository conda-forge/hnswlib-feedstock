# An example with reusing the memory of the deleted elements when new elements
# are being added (via `allow_replace_deleted` flag)
# https://github.com/nmslib/hnswlib/blob/v0.7.0/examples/python/EXAMPLES.md
